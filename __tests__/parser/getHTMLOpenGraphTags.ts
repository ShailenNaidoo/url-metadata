import { getHTMLOpenGraphTags, createHTMLInstance } from '../../parser';
...
describe('getHTMLOpenGraphTags', (): void => {
  test('should return object which contains specific keys', (): void => {
    const openGraphTags = getHTMLOpenGraphTags(html);

    expect(openGraphTags).toHaveProperty('site_name');
    expect(openGraphTags).toHaveProperty('type');
    expect(openGraphTags).toHaveProperty('image');
    expect(openGraphTags).toHaveProperty('title');
    expect(openGraphTags).toHaveProperty('description');
    expect(openGraphTags).toHaveProperty('url');
  });
});
